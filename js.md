- JavaScript
  - [js 基本数据类型](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#js-基本数据类型)
  - js 遍历对象和遍历数组的方式
    - [遍历对象](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#遍历对象)
    - [遍历数组](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#遍历数组)
  - [null 和 undefined 的区别](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#null-和-undefined-的区别)
  - [其他值到字符串的转换规则](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#其他值到字符串的转换规则)
  - [其他值到数字值的转换规则](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#其他值到数字值的转换规则)
  - [其他值到布尔类型的值的转换规则](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#其他值到布尔类型的值的转换规则)
  - [{} 和 [\] 的 valueOf 和 toString 的结果是什么](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#-和--的-valueof-和-tostring-的结果是什么)
  - [什么情况下会发生布尔值的隐式强制类型转换](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#什么情况下会发生布尔值的隐式强制类型转换)
  - [|| 和 && 操作符的返回值](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#-和--操作符的返回值)
  - [== 操作符的强制类型转换规则](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#-操作符的强制类型转换规则)
  - [如何将字符串转化为数字，例如 '12.3b'](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#如何将字符串转化为数字例如-123b)
  - [JavaScript 继承的几种实现方式](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#javascript-继承的几种实现方式)
  - [eval 是做什么的](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#eval-是做什么的)
  - [事件对象中的clientX offsetX screenX pageX的区别](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#事件对象中的clientx-offsetx-screenx-pagex的区别)
  - [三种事件模型是什么](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#三种事件模型是什么)
  - [如何阻止事件冒泡](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#如何阻止事件冒泡)
  - [如何阻止事件默认行为](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#如何阻止事件默认行为)
  - [事件代理/事件委托 以及 优缺点](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#事件代理事件委托-以及-优缺点)
  - [load 和 DOMContentLoaded 事件的区别](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#load-和-domcontentloaded-事件的区别)
  - [js判断图片是否加载完毕的方式](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#js判断图片是否加载完毕的方式)
  - [js 原型，原型链以及特点](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#js-原型原型链以及特点)
  - [instanceof 的作用](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#instanceof-的作用)
  - [Object.defineProperty 用法](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#objectdefineproperty-用法)
  - [js 延迟加载的方式有哪些](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#js-延迟加载的方式有哪些)
  - [js 脚本 defer 和 async 的区别](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#js-脚本-defer-和-async-的区别)
  - [async await](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#async-await)
  - [Event Loop 事件循环](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#event-loop-事件循环)
  - [JS 跨域怎么做](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#js-跨域怎么做)
  - [JSONP 怎么实现的](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#jsonp-怎么实现的)
  - [JOSNP 有什么优缺点](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#josnp-有什么优缺点)
  - [new 运算符的过程](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#new-运算符的过程)
  - [数组的 push() 和 pop() 方法的返回值是什么](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#数组的-push-和-pop-方法的返回值是什么)
  - [JS 作用域](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#js-作用域)
  - [ES6 新特性](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#es6-新特性)
  - [let 和 var 的区别](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#let-和-var-的区别)
  - [闭包的特性以及优缺点](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#闭包的特性以及优缺点)
  - [箭头函数与普通函数的区别](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#箭头函数与普通函数的区别)
  - [ES6 中箭头函数 VS 普通函数的 this 指向](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#es6-中箭头函数-vs-普通函数的-this-指向)
  - [ES6 class 和 ES5 函数的区别](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#es6-class-和-es5-函数的区别)
  - [JS 实现对象（都是简单类型的值）的深拷贝，一行代码](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#js-实现对象都是简单类型的值的深拷贝一行代码)
  - [JSON.parse(JSON.stringify(obj)) 实现深拷贝需要注意的问题](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#jsonparsejsonstringifyobj-实现深拷贝需要注意的问题)
  - Promise 是做什么的，有哪些API
    - [Promise用法](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#promise用法)
    - [Promise.prototype.then()](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#promiseprototypethen)
    - [Promise.prototype.catch()](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#promiseprototypecatch)
    - [Promise.all()](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#promiseall)
    - [Promise.race()](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#promiserace)
    - [Promise.resolve()](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#promiseresolve)
    - [Promise.reject()](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#promisereject)
  - [Promise不兼容怎么解决](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#promise不兼容怎么解决)
  - [Ajax 基本流程](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#ajax-基本流程)
  - [Ajax 的 readyState 的几种状态分别代表什么](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#ajax-的-readystate-的几种状态分别代表什么)
  - [Ajax 禁用浏览器的缓存功能](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#ajax-禁用浏览器的缓存功能)
  - 谈谈对前端工程化的理解
    - [模块化](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#模块化)
    - [组件化](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#组件化)
    - [规范化](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#规范化)
    - [自动化](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#自动化)
  - [js 的几种模块规范](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#js-的几种模块规范)
  - [ES6 模块与 CommonJS 模块、AMD、CMD 的差异](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#es6-模块与-commonjs-模块amdcmd-的差异)
  - [webpack 的功能](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#webpack-的功能)
  - [webpack 常用插件](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#webpack-常用插件)
  - [arguments怎么转化成真数组](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#arguments怎么转化成真数组)
  - [js的对象的常用的方法](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#js的对象的常用的方法)
  - [js的字符串的常用的方法](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#js的字符串的常用的方法)
  - [js的数组的常用的方法](https://github.com/lf2021/Front-End-Interview/blob/master/05.JavaScript/js.md#js的数组的常用的方法)
...
执行流程： [![event loop流程](https://github.com/lf2021/Front-End-Interview/raw/master/images/event%20loop.jpg)](https://github.com/lf2021/Front-End-Interview/blob/master/images/event loop.jpg)
...
1. JSONP (JSON with Padding) 通过动态创建 script，再请求一个带参网址实现跨域通信。

   > 参考链接：[jsonp的原理与实现](https://segmentfault.com/a/1190000007665361#articleHeader1)

2. CORS (跨域资源共享) CORS的基本思想就是使用自定义的HTTP头部让浏览器与服务器进行沟通，从而决定请求或响应是应该成功还是失败。
...
3. window.postMessage 现代浏览器中多窗口通信使用 HTML5 规范的 targetWindow.postMessage(data, origin);其中 data 是需要发送的对象，origin 是目标窗口的 origin。window.addEventListener('message', handler, false);handler 的 event.data 是 postMessage 发送来的数据，event.origin 是发送窗口的 origin，event.source 是发送消息的窗口引用

4. 服务器代理 内部服务器代理请求跨域 url，然后返回数据
...
> 原生 js 代码实现与基于 promise 实现请传送至专栏：[面试高频手撕代码题](https://github.com/lf2021/Front-End-Interview/blob/master/08.面试高频手撕代码题/面试高频手撕代码题.md)
