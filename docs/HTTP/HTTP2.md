...
<img :src="$withBase('/HTTP201.png')" alt="HTTP201"/>
...
<img :src="$withBase('/HTTP202.png')" alt="HTTP202"/>

**在 TCP 传输过程中，由于单个数据包的丢失而造成的阻塞称为 TCP 上的队头阻塞。**

接下来在看看队头阻塞是如何对 HTTP 2 产生影响的

<img :src="$withBase('/HTTP203.png')" alt="HTTP203"/>
...
<img :src="$withBase('/HTTP204.png')" alt="HTTP204"/>
